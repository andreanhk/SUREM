<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Oops.aspx.cs" Inherits="Error" %>
...
<head id="Head1" runat="server">
	...
	<title>Error - Domestic Gas Region V</title>
    ...
    <form id="form1" runat="server">
        ...
        <nav class="navbar navbar-default">
			...
			<div class="container">
                ...
                <img src="../assets/images/error.png" class="img-responsive center-block" height="350px" width="350px" />
				<h1 class="near">Mohon Maaf..</h1>
				<h1><small>Permintaan anda belum dapat kami proses saat ini.</small></h1>
